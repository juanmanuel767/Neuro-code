// ═══════════════════════════════════════════════════
// AQUILA WEBSITE — Comentarios, Contador y Descargas
// ═══════════════════════════════════════════════════

// ─── 200 Comentarios Positivos Pre-cargados ───
const COMENTARIOS_BASE = [
"¡Aquila es el futuro de la programación en español! 🦅","Increíble que pueda usar numpy directamente desde Aquila.","La función ia() me ahorró horas de trabajo.","Mejor que Python para prototipos rápidos, sin duda.","El Guardián me salvó de 3 bugs en un solo archivo.","Nunca pensé que programar en español fuera tan natural.","El servidor web integrado es una joya.","¡Compilé mi app a binario en 2 segundos!","La comunidad crece rápido, buen proyecto.","Uso Aquila para mis proyectos de machine learning.","El comando 'crear' es magia pura. IA generando código.","Me encanta la sintaxis limpia y legible.","Pasé de Python a Aquila en un día.","El sistema de módulos con 'usar' es brillante.","BaseDatos nativa sin ORM, directo al grano.","La auto-curación con IA es revolucionaria.","Perfecto para enseñar programación a principiantes.","Rust + Python = lo mejor de ambos mundos.","El REPL interactivo es muy útil para experimentar.","¡Por fin un lenguaje que habla mi idioma!",
"Aquila hace que el desarrollo full-stack sea trivial.","El rendimiento es impresionante comparado con Python puro.","Me encanta poder importar pandas sin configurar nada.","La documentación es clara y completa.","El Arquitecto generó mi proyecto completo en 30 segundos.","Funciones asíncronas nativas, sin librerías externas.","El manejo de errores con intentar/capturar es elegante.","Llevo 3 meses usando Aquila y no vuelvo atrás.","Excelente para APIs rápidas con ServidorWeb.","La integración con Groq es rapidísima.","OOP completa con clases en español, genial.","El sistema de caché de módulos remotos funciona perfecto.","Aquila + Ollama = IA sin pagar un centavo.","Me sorprendió la velocidad de compilación.","Ideal para startups que necesitan velocidad.","La conversión de tipos es muy intuitiva.","http_get y http_post nativos, sin requests.","El fallback automático de IA es muy inteligente.","Programar servidores nunca fue tan fácil.","¡Gran trabajo Juan Manuel!",
"Aquila es la evolución natural de Python.","El ecosistema crece cada semana.","Uso Aquila en producción y funciona perfecto.","La función entrada() para CLI es muy práctica.","El Guardián detectó un error que yo no veía.","Compilar a binario portátil es game-changer.","Me encanta la filosofía depredadora.","SQLite embebido sin instalar nada, genial.","Las lambdas funcionan exactamente como esperaba.","El código se lee como pseudocódigo.","Aquila maneja JSON de forma nativa y elegante.","Perfecta integración con hashlib de Python.","El REPL es perfecto para data science.","Funciones de texto como dividir/unir muy útiles.","La curva de aprendizaje es prácticamente nula.","Mejor DX que cualquier framework de Node.js.","El manejo de listas es potente y simple.","Aquila auth simplifica toda la configuración.","Me encanta que todo sea en español.","El proyecto tiene un futuro enorme.",
"Pasé mi bot de Discord de Python a Aquila.","La interoperabilidad con Python es seamless.","El servidor HTTP handles miles de requests.","Código más limpio que TypeScript.","El sistema de módulos .aq es muy organizado.","Aquila + Claude = productividad x10.","Diccionarios nativos con sintaxis limpia.","El rango() funciona igual que en Python.","Me ahorro instalar pip, todo viene integrado.","La compilación cruzada sería increíble.","Uso Aquila para automatización de tareas.","El motor Rust le da una solidez brutal.","Funciones de primera clase, como debe ser.","El manejo de archivos es simple y directo.","Aquila hace que Python parezca verbose.","El Arquitecto entiende contexto complejo.","Excelente para microservicios.","La comunidad es muy acogedora.","Cada actualización trae mejoras significativas.","El lenguaje más innovador de 2026.",
"Estoy migrando todo mi backend a Aquila.","La función tipo() es muy útil para debugging.","ServidorWeb + BaseDatos = stack completo.","No necesito Express, ni Flask, ni Django.","Aquila es ligero, rápido y poderoso.","El soporte para Groq es un diferenciador.","Me encanta el emoji del águila 🦅.","Programar en español reduce mis errores.","El código Aquila es auto-documentado.","El fallback a Ollama es una idea genial.","Aquila resuelve problemas reales.","Instalación simple, sin dependencias.","El Guardián es como tener un mentor IA.","Uso Aquila para enseñar a mis alumnos.","La modularidad con exportar es profesional.","Aquila democratiza la programación.","Full-stack en un solo lenguaje y archivo.","El parser es robusto y da buenos errores.","Mejor que Lua para scripting embebido.","Aquila es arte funcional.",
"La velocidad de ejecución me impresionó.","Todo funciona out-of-the-box.","El diseño del lenguaje es muy coherente.","Aquila hace simple lo que antes era difícil.","Me gusta que los booleanos sean verdadero/falso.","El comando mientras es super intuitivo.","PyO3 bridge funciona sin friction.","Hice un chatbot con ia() en 10 líneas.","Aquila es el lenguaje que necesitábamos.","El manejo de nulo es limpio.","Aquila es perfecto para hackathons.","La documentación web es profesional.","Nunca vi un lenguaje con IA integrada.","El sistema de rutas del servidor es flexible.","Aquila compite con lenguajes enterprise.","Me encanta el concepto del Depredador.","Funciones matemáticas nativas en Rust.","Aquila es mi lenguaje favorito.","Gran rendimiento en data processing.","El futuro es programar en español.",
"Acabo de descubrir Aquila y estoy fascinado.","El REPL con historial sería perfecto.","Llevo una semana y ya hice 3 proyectos.","La integración IA es la killer feature.","Mejor error handling que Go.","Aquila es minimalista pero poderoso.","El ecosistema Python es infinito para Aquila.","Muy buen trabajo con la documentación.","Aquila es productividad pura.","El crear proyectos con IA es adictivo.","Aquila me hace sentir desarrollador 10x.","La sintaxis es limpia como Swift.","funciona perfecto en mi Ubuntu.","El equipo de desarrollo es talentoso.","Aquila merece más reconocimiento.","Lo usé para un proyecto universitario, A+.","Deployment fácil con --compilar.","Aquila simplifica DevOps.","La abstracción del servidor es elegante.","Voy a contribuir al código fuente.",
"Aquila cambió mi forma de pensar código.","Lo mejor en lenguajes latinoamericanos.","ia() es como tener un copiloto siempre.","El sistema de imports es genius.","Perfecto para IoT con Rust detrás.","Aquila + Raspberry Pi = potencia.","El Guardián debería existir en todos los lenguajes.","Me encanta la filosofía del proyecto.","Funciones asíncronas sin callback hell.","Aquila es innovación latinoamericana.","El lenguaje se siente completo.","Cada función tiene nombre en español.","Aquila es accesible para todos.","El mejor proyecto open source de 2026.","Programar nunca fue tan divertido.","La comunidad está creciendo exponencialmente.","Aquila resuelve el problema del inglés.","Velocidad de Rust, facilidad de Python.","El diseño web del proyecto es premium.","¡Felicidades al equipo de Aquila!"
];
